        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12 space-y-6">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Experience the ultimate thrill of being at the heart of innovation with Formation X! Organize hackathons, manage participant applications, track submissions, streamline communications, handle reimbursements, and oversee judging — all seamlessly on our platform. Join hundreds of organizers and take your hackathons to the next level with Formation X.
            </p>
            ...
            >
              ...
              Organize your hackathon on Formation X
            </Button>
          </div>
